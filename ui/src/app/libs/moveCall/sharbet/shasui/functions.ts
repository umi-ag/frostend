...
export function totalSupply( txb: TransactionBlock, treasuryCap: ObjectArg ) { return txb.moveCall({ target: `${PUBLISHED_AT}::shasui::total_supply`, arguments: [ obj(txb, treasuryCap) ], }) }

export interface MintArgs { treasuryCap: ObjectArg; u64: bigint | TransactionArgument }

export function mint( txb: TransactionBlock, args: MintArgs ) { return txb.moveCall({ target: `${PUBLISHED_AT}::shasui::mint`, arguments: [ obj(txb, args.treasuryCap), pure(txb, args.u64, `u64`) ], }) }

export interface BurnArgs { treasuryCap: ObjectArg; coin: ObjectArg }

export function burn( txb: TransactionBlock, args: BurnArgs ) { return txb.moveCall({ target: `${PUBLISHED_AT}::shasui::burn`, arguments: [ obj(txb, args.treasuryCap), obj(txb, args.coin) ], }) }
