...
bcs.registerStructType( "0xb9f67019f1b3a558086a1439f131f988be4e1d45fea98c4be82cbb42a6e32fed::root::Root", {
id: `0x2::object::UID`,
} )

export function isRoot(type: Type): boolean { return type === "0xb9f67019f1b3a558086a1439f131f988be4e1d45fea98c4be82cbb42a6e32fed::root::Root"; }

export interface RootFields { id: string }

export class Root { static readonly $typeName = "0xb9f67019f1b3a558086a1439f131f988be4e1d45fea98c4be82cbb42a6e32fed::root::Root"; static readonly $numTypeParams = 0;
