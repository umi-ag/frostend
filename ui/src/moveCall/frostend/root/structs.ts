...
bcs.registerStructType( "0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::root::Root", {
id: `0x2::object::UID`,
} )

export function isRoot(type: Type): boolean { return type === "0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::root::Root"; }

export interface RootFields { id: string }

export class Root { static readonly $typeName = "0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::root::Root"; static readonly $numTypeParams = 0;
