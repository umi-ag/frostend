...
bcs.registerStructType( "0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::PTCoin<T0>", {
dummy_field: `bool`,
} )

export function isPTCoin(type: Type): boolean { return type.startsWith("0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::PTCoin<"); }

export interface PTCoinFields { dummyField: boolean }

export class PTCoin { static readonly $typeName = "0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::PTCoin"; static readonly $numTypeParams = 1;
...
bcs.registerStructType( "0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::YTCoin<T0>", {
dummy_field: `bool`,
} )

export function isYTCoin(type: Type): boolean { return type.startsWith("0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::YTCoin<"); }

export interface YTCoinFields { dummyField: boolean }

export class YTCoin { static readonly $typeName = "0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::YTCoin"; static readonly $numTypeParams = 1;
...
bcs.registerStructType( "0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::Vault<T0>", {
id: `0x2::object::UID`,
coin_sy_reserve: `0x2::balance::Balance<T0>`,
coin_pt_reserve: `0x2::balance::Balance<0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::PTCoin<T0>>`,
coin_yt_reserve: `0x2::balance::Balance<0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::YTCoin<T0>>`,
coin_pt_supply: `0x2::balance::Supply<0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::PTCoin<T0>>`,
coin_yt_supply: `0x2::balance::Supply<0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::YTCoin<T0>>`,
} )

export function isVault(type: Type): boolean { return type.startsWith("0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::Vault<"); }
...
export class Vault { static readonly $typeName = "0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::Vault"; static readonly $numTypeParams = 1;
...
; readonly id: string; readonly coinSyReserve: Balance; readonly coinPtReserve: Balance; readonly coinYtReserve: Balance; readonly coinPtSupply: Supply; readonly coinYtSupply: Supply
 ...
 static fromFields( typeArg: Type, fields: Record<string, any> ): Vault { return new Vault( typeArg, { id: UID.fromFields(fields.id).id, coinSyReserve: Balance.fromFields(`${typeArg}`, fields.coin_sy_reserve), coinPtReserve: Balance.fromFields(`0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::PTCoin<${typeArg}>`, fields.coin_pt_reserve), coinYtReserve: Balance.fromFields(`0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::YTCoin<${typeArg}>`, fields.coin_yt_reserve), coinPtSupply: Supply.fromFields(`0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::PTCoin<${typeArg}>`, fields.coin_pt_supply), coinYtSupply: Supply.fromFields(`0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::YTCoin<${typeArg}>`, fields.coin_yt_supply) } ) }

 static fromFieldsWithTypes(item: FieldsWithTypes): Vault { if (!isVault(item.type)) { throw new Error("not a Vault type");

 } const { typeArgs } = parseTypeName(item.type);

 return new Vault( typeArgs[0], { id: item.fields.id.id, coinSyReserve: new Balance( `${typeArgs[0]}`, BigInt(item.fields.coin_sy_reserve) ), coinPtReserve: new Balance( `0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::PTCoin<${typeArgs[0]}>`, BigInt(item.fields.coin_pt_reserve) ), coinYtReserve: new Balance( `0x3af8a3597faf9e5a7eb48d4be3ce7a9493d5acea3b8630fb8be9bc8fde2a5ad6::vault::YTCoin<${typeArgs[0]}>`, BigInt(item.fields.coin_yt_reserve) ), coinPtSupply: Supply.fromFieldsWithTypes(item.fields.coin_pt_supply), coinYtSupply: Supply.fromFieldsWithTypes(item.fields.coin_yt_supply) } ) }
