...
bcs.registerStructType( "0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::PTCoin<T0>", {
dummy_field: `bool`,
} )

export function isPTCoin(type: Type): boolean { return type.startsWith("0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::PTCoin<"); }

export interface PTCoinFields { dummyField: boolean }

export class PTCoin { static readonly $typeName = "0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::PTCoin"; static readonly $numTypeParams = 1;
...
bcs.registerStructType( "0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::YTCoin<T0>", {
dummy_field: `bool`,
} )

export function isYTCoin(type: Type): boolean { return type.startsWith("0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::YTCoin<"); }

export interface YTCoinFields { dummyField: boolean }

export class YTCoin { static readonly $typeName = "0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::YTCoin"; static readonly $numTypeParams = 1;
...
bcs.registerStructType( "0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::Vault<T0>", {
id: `0x2::object::UID`,
coin_sy_reserve: `0x2::balance::Balance<T0>`,
coin_pt_reserve: `0x2::balance::Balance<0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::PTCoin<T0>>`,
coin_yt_reserve: `0x2::balance::Balance<0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::YTCoin<T0>>`,
coin_pt_supply: `0x2::balance::Supply<0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::PTCoin<T0>>`,
coin_yt_supply: `0x2::balance::Supply<0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::YTCoin<T0>>`,
issued_at: `u64`,
matures_at: `u64`,
} )

export function isVault(type: Type): boolean { return type.startsWith("0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::Vault<"); }
...
export class Vault { static readonly $typeName = "0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::Vault"; static readonly $numTypeParams = 1;
 ...
 static fromFields( typeArg: Type, fields: Record<string, any> ): Vault { return new Vault( typeArg, { id: UID.fromFields(fields.id).id, coinSyReserve: Balance.fromFields(`${typeArg}`, fields.coin_sy_reserve), coinPtReserve: Balance.fromFields(`0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::PTCoin<${typeArg}>`, fields.coin_pt_reserve), coinYtReserve: Balance.fromFields(`0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::YTCoin<${typeArg}>`, fields.coin_yt_reserve), coinPtSupply: Supply.fromFields(`0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::PTCoin<${typeArg}>`, fields.coin_pt_supply), coinYtSupply: Supply.fromFields(`0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::YTCoin<${typeArg}>`, fields.coin_yt_supply), issuedAt: BigInt(fields.issued_at), maturesAt: BigInt(fields.matures_at) } ) }

 static fromFieldsWithTypes(item: FieldsWithTypes): Vault { if (!isVault(item.type)) { throw new Error("not a Vault type");

 } const { typeArgs } = parseTypeName(item.type);

 return new Vault( typeArgs[0], { id: item.fields.id.id, coinSyReserve: new Balance( `${typeArgs[0]}`, BigInt(item.fields.coin_sy_reserve) ), coinPtReserve: new Balance( `0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::PTCoin<${typeArgs[0]}>`, BigInt(item.fields.coin_pt_reserve) ), coinYtReserve: new Balance( `0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::vault::YTCoin<${typeArgs[0]}>`, BigInt(item.fields.coin_yt_reserve) ), coinPtSupply: Supply.fromFieldsWithTypes(item.fields.coin_pt_supply), coinYtSupply: Supply.fromFieldsWithTypes(item.fields.coin_yt_supply), issuedAt: BigInt(item.fields.issued_at), maturesAt: BigInt(item.fields.matures_at) } ) }
