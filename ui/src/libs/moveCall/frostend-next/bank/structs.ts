...
bcs.registerStructType( "0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::bank::Bank<T0>", {
id: `0x2::object::UID`,
coin_sy_reserve: `0x2::balance::Balance<T0>`,
} )

export function isBank(type: Type): boolean { return type.startsWith("0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::bank::Bank<"); }

export interface BankFields { id: string; coinSyReserve: Balance }

export class Bank { static readonly $typeName = "0x103ebb7a6bb84c8218126be46dd8ac71754396e8be8d8916a6fd93c72eef615f::bank::Bank"; static readonly $numTypeParams = 1;
