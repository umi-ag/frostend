...
bcs.registerStructType( "0xfb5075d2c8cee0810eab47d90ff41206dcbc1409b6fa404eafacbcd2aea61286::bank::Bank<T0>", {
id: `0x2::object::UID`,
coin_sy_reserve: `0x2::balance::Balance<T0>`,
} )

export function isBank(type: Type): boolean { return type.startsWith("0xfb5075d2c8cee0810eab47d90ff41206dcbc1409b6fa404eafacbcd2aea61286::bank::Bank<"); }

export interface BankFields { id: string; coinSyReserve: Balance }

export class Bank { static readonly $typeName = "0xfb5075d2c8cee0810eab47d90ff41206dcbc1409b6fa404eafacbcd2aea61286::bank::Bank"; static readonly $numTypeParams = 1;
