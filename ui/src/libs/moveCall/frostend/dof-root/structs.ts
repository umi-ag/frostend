...
bcs.registerStructType( "0xfb5075d2c8cee0810eab47d90ff41206dcbc1409b6fa404eafacbcd2aea61286::dof_root::Root", {
id: `0x2::object::UID`,
} )

export function isRoot(type: Type): boolean { return type === "0xfb5075d2c8cee0810eab47d90ff41206dcbc1409b6fa404eafacbcd2aea61286::dof_root::Root"; }

export interface RootFields { id: string }

export class Root { static readonly $typeName = "0xfb5075d2c8cee0810eab47d90ff41206dcbc1409b6fa404eafacbcd2aea61286::dof_root::Root"; static readonly $numTypeParams = 0;
