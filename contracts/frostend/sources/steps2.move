module frostend::steps2 {
    ...
    public fun swap_sy_to_yt<X>(
        ...
        let amount_small = balance::value(&balance_sy); // 4
        let amount_big = amount_small / 4 * 96;

        deposit_sy(balance_sy, vault);
        borrow_sy(amount_big, vault, bank);
        mint_pt_and_yt(amount_big + amount_small, vault);
        withdraw_yt(amount_small, vault)
    }
    ...
    public fun swap_yt_to_sy<X>(
        ...
        let amount_small = balance::value(&balance_yt); // 4
        let amount_big = amount_small / 4 * 96;

        deposit_yt(balance_yt, vault);
        burn_pt_and_yt(amount_big + amount_small, vault);
        payback_sy(amount_big, vault, bank);
        withdraw_sy(amount_small, vault)
    }
    ...
    public fun swap_pt_to_yt<X>(
        ...
        let amount_small = balance::value(&balance_pt); // 4
        let amount_big = amount_small / 4 * 96;

        deposit_pt(balance_pt, vault);
        borrow_sy(amount_big + amount_small, vault, bank);
        mint_pt_and_yt(amount_big + amount_small, vault);
        withdraw_yt(amount_small, vault)
    }
    ...
    public fun swap_yt_to_pt<X>(
        ...
        deposit_yt(balance_yt, vault);
        burn_pt_and_yt(amount_big + amount_small, vault);
        payback_sy(amount_big + amount_small, vault, bank);
        withdraw_pt(amount_small, vault)
    }
}
